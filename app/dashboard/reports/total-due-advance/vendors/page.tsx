    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow py-6 px-4">
        <div className="flex items-center gap-2 mb-6 text-sm text-gray-500">
             <span>Dashboard</span> <span>&gt;</span> <span>Report</span> <span>&gt;</span> <span className="font-medium text-gray-900">Total Due/Advance (Vendor)</span>
        </div>
        ...
        <div className="mb-6 flex flex-col md:flex-row gap-4 items-end justify-between">
          <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto items-end">
            ...
            <div className="space-y-1 w-full md:w-[300px]">
              <Label className="text-xs text-red-500 font-normal">* Select Vendor</Label>
              <VendorSelect
                value={selectedVendor}
                onChange={(id) => setSelectedVendor(id || "all")}
                preloaded={vendorsList}
        ...
        <div className="mb-4">
            <h2 className="text-lg font-semibold">Total Due/Advance (Vendor)</h2>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-100 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-semibold text-blue-600">Vendor Name</th>
